...
const PAGE_TEMPLATE = {
  name: 'home',
  description: 'WKND homepage: hero carousel, featured article, recent articles cards, promo hero banner, and adventures cards grid.',
  urls: [
  ...
  blocks: [
    ...
    {
      name: 'cards-articles',
      instances: ['.image-list.list.aem-GridColumn'],
    },
    {
      name: 'hero-promo',
...
export default {
  transform: (payload) => {
    ...
    //    the empty-path crash in the bundled importer.
