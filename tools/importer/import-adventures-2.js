...
const PAGE_TEMPLATE = {
  name: 'adventures-2',
  description: 'WKND adventures listing: intro hero and a category-filtered tabbed grid of adventure cards.',
  urls: [
  ...
  blocks: [
    {
      ...
      instances: ['.teaser.cmp-teaser--hero.aem-GridColumn'],
    },
    {
      name: 'tabs-filter',
      instances: ['.tabs.panelcontainer.aem-GridColumn'],
    },
  ],
};
